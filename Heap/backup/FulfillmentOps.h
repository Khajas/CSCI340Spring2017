...
//
void take_new_order(vector<Order>& vecOrders, const vector<string>& customers, const vector<string>& shippingSpeeds){
        ...
        vecOrders.push_back(new_order);					// Push it to the vector of orders
}
